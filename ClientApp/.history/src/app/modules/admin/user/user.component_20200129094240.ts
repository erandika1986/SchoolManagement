...
import { UserRoleModel } from '../../../models/account/user-role.model';
...
export class UserComponent implements OnInit {
  ...
  openModal(user: UserRoleModel) {
    this.bsModalRef = this.bsModalService.show(AddEditUserPopUpComponent, {class: 'modal-lg', backdrop: 'static'}, overlayConfigFactory);
  }
